...
* Once you have your `.npmrc` and before you run `npm install` command, replace all occurrences of `@mohsenrzva/bamboo-shared` with your own shared library.
* After replacing all occurrences of `@mohsenrzva/bamboo-shared`, you can then run `npm install` command.
...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/bamboo-users .`
  * `docker tag <your-dockerhub-username>/bamboo-users <your-dockerhub-username>/bamboo-users:stable`
  * `docker push <your-dockerhub-username>/bamboo-users:stable`
