...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/bamboo-auth .`
  * `docker tag <your-dockerhub-username>/bamboo-auth <your-dockerhub-username>/bamboo-auth:stable`
  * `docker push <your-dockerhub-username>/bamboo-auth:stable`
