...
* Steps to build and push your image to docker hub
  * `docker build -t <your-dockerhub-username>/bamboo-chat .`
  * `docker tag <your-dockerhub-username>/bamboo-chat <your-dockerhub-username>/bamboo-chat:stable`
  * `docker push <your-dockerhub-username>/bamboo-chat:stable`
